...
import {
  Brain, FileText, Github, Award, Users, Star, CheckCircle, ArrowRight,
  Timer, Phone, Mail, MessageCircle, Zap, Target, TrendingUp, Sparkles,
  ExternalLink, Heart, Shield, MessageSquare,
} from "lucide-react";
...
const Index = () => {
  ...
  const features = [
    { icon: <Brain className="h-9 w-9" />, title: "AI Resume Analyzer", description: "Get intelligent feedback on your resume with AI-powered scoring and suggestions", color: "from-purple-500 to-pink-500" },
    { icon: <FileText className="h-9 w-9" />, title: "ATS-Friendly Templates", description: "Professional resume templates optimized for Applicant Tracking Systems", color: "from-blue-500 to-cyan-500" },
    { icon: <Github className="h-9 w-9" />, title: "GitHub Integration", description: "Automatically import your projects and showcase your coding journey", color: "from-green-500 to-emerald-500" },
    { icon: <Award className="h-9 w-9" />, title: "Placement Tracker", description: "Monitor your placement readiness with comprehensive progress tracking", color: "from-orange-500 to-red-500" },
  ];

  const testimonials = [
    { name: "Priya ", role: "Software Engineer ", content: "This platform helped me land my dream job! The AI resume analyzer was incredibly helpful.", rating: 5 },
    { name: "Kathyaini", role: "Senior .NET Developer", content: "The GitHub integration saved me hours of work. My portfolio looks amazing now!", rating: 5 },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
            ...
            <div className="space-y-8">
              ...
              <h1 className="text-[44px] md:text-[56px] font-extrabold leading-tight">
                ...
                <span className="text-foreground">Portfolio & Resume</span><br />
              ...
              <div className="flex items-center gap-8">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[15px] text-muted-foreground">5.0 Rating</span>
                </div>
                <div className="flex items-center gap-2">
                  <Target className="h-5 w-5 text-success" />
                  <span className="text-[15px] text-muted-foreground">100% Success Rate</span>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                  <div className="text-5xl font-extrabold text-primary">₹250</div>
                  <div className="text-2xl text-muted-foreground line-through">₹999</div>
                  <Badge className="bg-accent text-white px-3 py-1 text-sm">75% OFF</Badge>
                </div>
                ...
                <div className="hidden lg:block">
                  <div className="absolute left-[-78px] top-8">
                    <div className="animate-wiggle-slow rounded-2xl bg-gradient-to-b from-indigo-900/40 to-indigo-900/10 border border-indigo-500/20 px-6 py-5 text-center shadow-lg">
                      <div className="text-[24px] font-bold text-indigo-300">500+</div>
                      <div className="text-[12px] text-indigo-200/80">Portfolio Templates</div>
                    </div>
                  </div>
                  ...
                  <div className="absolute left-[-78px] bottom-10">
                    <div className="animate-wiggle-slower rounded-2xl bg-gradient-to-b from-indigo-900/40 to-indigo-900/10 border border-indigo-500/20 px-6 py-5 text-center shadow-lg">
                      <div className="text-[18px] font-semibold text-indigo-300">AI</div>
                      <div className="text-[12px] text-indigo-200/80">Powered Tools</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="hidden lg:block">
                  <div className="absolute right-[-78px] bottom-6">
                    <div className="animate-wiggle-slowest rounded-2xl bg-gradient-to-b from-indigo-900/40 to-indigo-900/10 border border-indigo-500/20 px-7 py-6 text-center shadow-lg">
                      <div className="text-[24px] font-bold text-indigo-300">98%</div>
                      <div className="text-[12px] text-indigo-200/80">Job Success Rate</div>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="glass-card p-9 rounded-3xl max-w-md mx-auto hover-lift">
            ...
            <div className="space-y-4 mb-8 text-[16px]">
              <div className="flex items-center justify-center"><CheckCircle className="h-5 w-5 text-success mr-3" /><span>AI Resume Analysis</span></div>
              <div className="flex items-center justify-center"><CheckCircle className="h-5 w-5 text-success mr-3" /><span>Unlimited Templates</span></div>
              <div className="flex items-center justify-center"><CheckCircle className="h-5 w-5 text-success mr-3" /><span>GitHub Integration</span></div>
              <div className="flex items-center justify-center"><CheckCircle className="h-5 w-5 text-success mr-3" /><span>Portfolio Website</span></div>
            </div>
            <Link to="/contact">
              <Button className="bg-gradient-primary hover:opacity-90 text-white shadow-glow text-lg px-9 py-5">
                Get Started Free
            ...
            {features.map((feature, index) => (
              <Card key={index} className="glass-card border-0 hover-lift hover-glow">
                <CardContent className="p-7 text-center">
                  <div className={`w-18 h-18 mx-auto mb-4 rounded-2xl bg-gradient-to-r ${feature.color} flex items-center justify-center text-white`}>
                    {feature.icon}
                  </div>
                  <h3 className="text-[19px] font-semibold mb-2">{feature.title}</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-6">
                Hi! I'm the founder of PortfolioBuilder. Having successfully deployed 3 client portfolios in the U.S. and helped hundreds of students land their dream jobs, I understand what recruiters are looking for.
              </p>
              <div className="space-y-4 text-[16px]">
                <div className="flex items-center"><CheckCircle className="h-5 w-5 text-success mr-3" /><span>3 U.S. Client Portfolios Successfully Deployed</span></div>
                <div className="flex items-center"><CheckCircle className="h-5 w-5 text-success mr-3" /><span>500+ Reference Portfolios Available</span></div>
                <div className="flex items-center"><CheckCircle className="h-5 w-5 text-success mr-3" /><span>95% Placement Success Rate</span></div>
              </div>
              <div className="flex flex-col sm:flex-row gap-4 mt-8">
                <Button asChild className="bg-gradient-primary hover:opacity-90 text-white">
                  <a href="tel:9059086142"><Phone className="mr-2 h-4 w-4" />Call: 9059086142</a>
                </Button>
            ...
            <div className="text-center">
              <div className="glass-card p-9 rounded-3xl hover-lift">
                <img src={founderImage} alt="Founder" className="w-72 h-72 object-cover rounded-2xl mx-auto mb-4 shadow-glow" />
                <h3 className="text-[24px] font-bold mb-2">Kesava Masanam</h3>
                <p className="text-[15px] text-muted-foreground mb-4">Founder & Portfolio Expert</p>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">See how our students showcase their skills</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { title: "Tech Portfolio", description: "Modern developer portfolio with projects showcase", image: "https://res.cloudinary.com/dswrgvg3c/image/upload/v1758576631/tech_ksczhd.png" },
              { title: "Design Portfolio", description: "Creative designer portfolio with stunning visuals", image: "https://res.cloudinary.com/dswrgvg3c/image/upload/v1758576468/Design_rqdid9.png" },
              { title: "Data Science Portfolio", description: "Analytics-focused portfolio with project insights", image: "https://res.cloudinary.com/dswrgvg3c/image/upload/v1758576986/data_science_ra0pzj.png" },
            ].map((sample, index) => (
              <Card key={index} className="glass-card border-0 overflow-hidden hover-lift group">
                <div className="h-48 overflow-hidden">
                  <img src={sample.image} alt={sample.title} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" />
                </div>
                <CardContent className="p-6">
                  ...
                  <Link to="/products">
                    <Button variant="outline" size="sm" className="glass-button">View Sample</Button>
                  </Link>
                </CardContent>
              </Card>
            ))}
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="glass-card p-12 rounded-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link to="/contact">
                <Button variant="outline" className="glass-button text-lg px-8 py-4">Contact Us</Button>
              </Link>
            </div>
          </div>
        </div>
          ...
          <div className="border-t border-white/10 pt-6">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <div className="flex items-center gap-4 text-sm text-gray-400">
                <span>© 2025 PortfolioAI. All rights reserved.</span><span>•</span>
            ...
            <div className="flex flex-wrap items-center justify-center gap-6 mt-6 pt-6 border-t border-white/10 text-xs text-gray-400">
              <div className="flex items-center gap-1"><Shield className="w-4 h-4 text-green-400" /><span>Trusted by students from top colleges</span></div>
              <div className="flex items-center gap-1"><CheckCircle className="w-4 h-4 text-green-400" /><span>98% job success rate</span></div>
              <div className="flex items-center gap-1"><Award className="w-4 h-4 text-yellow-400" /><span>3 US clients successfully deployed</span></div>
            </div>
          </div>
        </div>
      </footer>
